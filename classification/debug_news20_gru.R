...
model1 <- define_memnet_lstm_conv1d_single(newsDataset$vocab$maxlen, 
...
history1 <- train_model(model1, 
                        ...
                        numEpochs=numEpochs,
                        logdir="logs/news/2", 
                        checkpointPath="checkpoints/news_memnet_lstm_conv1d_single.h5")

png("news_memnet_embed_lstm.png", width="800", height="600")
plot(history1)
dev.off()

## Save the model.
model1 %>% save_model_hdf5("saved_models/test_news_memnet_lstm_single.h5")
