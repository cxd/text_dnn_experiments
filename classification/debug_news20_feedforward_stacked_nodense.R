...
model1 <- embedding_feedforward_stacked_cnn_softmax_nodense(newsDataset$vocab$maxlen, 
...
if (load_checkpoint && file.exists("checkpoints/news_feedforward_cnn_stacked_nodense.h5")) {
  model1 <- load_model_hdf5("checkpoints/news_feedforward_cnn_stacked_nodense.h5")
}
...
history1 <- train_model(model1, 
                        ...
                        numEpochs=numEpochs,
                        logdir="logs/news/2", 
                        checkpointPath="checkpoints/news_feedforward_cnn_stacked_nodense.h5")

png("news_feedforward_cnn_stacked_nodense.png", width="800", height="600")
plot(history1)
dev.off()

## Save the model.

model1 %>% save_model_weights_hdf5("saved_models/news_feedforward_cnn_stacked_nodense_weights.h5")
